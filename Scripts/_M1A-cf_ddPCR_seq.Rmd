...
bibliography: [../../_bibFiles/_Normalization.bib, ../../_bibFiles/_RUV.bib, ../../_bibFiles/_RUVM.bib, ../../_bibFiles/_ddPCR.bib, ../../_bibFiles/_contam.bib, ../../_bibFiles/_LoD.bib, ../../_bibFiles/_AI.bib]
...
```{r m1a-input-params-all, echo = FALSE, results = "asis", eval=T, echo=F}
...
# The ddPCR Platform {#ddpcr-platform}
...
```{r m1a-Quan-2018-fig-3, fig.cap = CAPTION,  out.width = "800px", fig.align = 'center', eval=F}
...
```{r m1a-Basu-2017-fig3, fig.cap = CAPTION,  out.width = "800px", fig.align = 'center', eval=F}
...
```{r m1a-Basu-2017-fig4, fig.cap = CAPTION,  out.width = "800px", fig.align = 'center', eval=F}
...
```{r m1a-no-vol-var-conc-0p1-example, cache=T, cache.vars='', fig.cap = paste0("No Volume Variability, Conc =", 100*CONC, '%'), fig.height=6, fig.width=8}
...
```{r m1a-no-vol-var-conc-0p1-run-sim, cache=T, cache.vars="novolvar_conc_0p1_frm", fig.cap = paste0("No Volume Variability, Conc =", 100*CONC, '%')}
...
```{r m1a-no-vol-var-conc-0p1-plot-sim, cache=T, cache.vars="novolvar_conc_0p1_frm", fig.cap = paste0("No Volume Variability, Conc =", 100*CONC, '%'), fig.heigth=6, fig.width=8}
...
```{r m1a-no-vol-var-conc-0p001-example, cache=T, cache.vars='', fig.cap = paste0("No Volume Variability, Conc =", 100*CONC, '%'), fig.height=6, fig.width=8}
...
```{r m1a-no-vol-var-conc-0p001-run-sim, cache=T, cache.vars="novolvar_conc_0p001_frm", fig.cap = paste0("No Volume Variability, Conc =", 100*CONC, '%')}
...
```{r m1a-no-vol-var-conc-0p001-plot-sim, cache=T, cache.vars="novolvar_conc_0p001_frm", fig.cap = paste("No Volume Variability, Conc =", CONC), fig.heigth=6, fig.width=8}
...
```{r m1a-rd-dorazio-dilution-data, cache=T, cache.vars = "dorazio_dilution_frm"}
...
```{r m1a-annot-dorazio, cache=F, echo=T}
...
```{r m1a-plot-dorazio-dilution, cache=T, cache.vars='', fig.height= 6, fig.width = 8, fig.cap ="Dorazio Dilution Data"}
...
```{r m1a-plot-ddpcr-seq-counts, cache=T, cache.vars='dorazio_byDil_frm', fig.height= 6, fig.width = 8, fig.cap ="Dorazio Dilution Data - Counts: total, pos, neg"}
...
```{r m1a-rereplot-dorazio-dilution, cache=T, cache.vars='dorazio_byDil_frm', fig.height= 6, fig.width = 8, fig.cap ="Dorazio Dilution Data"}
...
```{r m1a-dorazio-dilution-glm-fit, cache=T, cache.vars=c('cloglog_fit', "dorazio_dilution_glm_frm")}
...
```{r m1a-cloglog-residuals, cache=T, cache.vars='', fig.height= 6, fig.width = 8, fig.cap ="Dorazio Dilution Data"}
...
```{r m1a-rule-of-ln-alpha-over-n,cache=T, cache.vars='',fig.cap="The Rules of -ln(a) over n"}
...
```{r m1a-Pinheiro-2012-fig1, fig.cap = CAPTION,  out.width = "800px", fig.align = 'center'}
...
```{r m1a-Pinheiro-2012-fig2, fig.cap = CAPTION,  out.width = "800px", fig.align = 'center'}
...
```{r m1a-pick-four-plates, cache=T, cache.vars = c("TPD_Plate_vec", "four_TPD_plates", "all_TPD_plates_frm"), include=F, eval=F}
 ### CLEARE CACH
...
```{r m1a-examples-bin-abn-tmef, cache=T, cache.vars = "", fig.cap="Example plate fit and Dx", results = "asis", eval=F}
...
```{r ARC-m1a-lw-plots, fig.height=6, fig.width=8, fig.cap ='', eval=F}
library(readr)
library(tidyverse)
library(ggpubr)
library(ggplot2)
...
```{r ARC-m1a-plot-2-dorazio-dilution, cache=T, cache.vars='', fig.height= 6, fig.width = 8, fig.cap ="Dorazio Dilution Data"}
...
```{r ARC-m1a-define-plot-fun, cache=T, cache.vars=c("plot_cov_by_batch_f")}
 ############################################
DEBUG <- function() {
...
<!-- To run
# nohup Rscript -e "knitr::knit2html('_M1A-cf_ddPCR_seq.Rmd')" > _M1A-cf_ddPCR_seq.log  &

# Or
# nohup Rscript -e "rmarkdown::render('_M1A-cf_ddPCR_seq.Rmd')" > _M1A-cf_ddPCR_seq.log  &
